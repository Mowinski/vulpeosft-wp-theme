...
function wp_bootstrap_starter_scripts() {
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'advent-pro') {
        wp_enqueue_style( 'wp-bootstrap-starter-advent-pro-font', 'https://fonts.googleapis.com/css?family=Advent Pro:100,300,400,500,600,700');
    }
    ...
    wp_enqueue_style('vulpesoft-theme', get_template_directory_uri() . '/inc/assets/css/vulpesoft.css');
}
