...
function get_slide_item($id, $active) {
	$image = get_theme_mod($id);
	if(!$image) return;

	$title = get_theme_mod($id . '_title');
	$subtitle = get_theme_mod($id . '_subtitle');
	$button_one_text = get_theme_mod($id . '_button_one_text');
	$button_two_text = get_theme_mod($id . '_button_two_text');
	$button_one_href = get_theme_mod($id . '_button_one_href');
	$button_two_href = get_theme_mod($id . '_button_two_href');
	$button_color = get_theme_mod($id . '_button_color');
	$button_bottom_color = get_theme_mod($id . '_button_bottom_color');

	?>
	  <div class="carousel-item<?php echo $active ? " active" : "";?>">
        <img src="<?php echo $image; ?>" class="d-block w-100" alt="<? echo $title; ?>">
        <div class="carousel-caption d-none d-md-block vulpesoft-carousel-caption">
          <h5 class="font-semi-bold"><?php echo $title; ?></h5>
          <h6 class="font-medium"><?php echo $subtitle; ?></h6>
		  <div class="button-area">
			<?php if($button_one_href) : ?>
				<a href="<?php echo $button_one_href; ?>" target="_blank" class="btn btn-primary font-regular" style="background-color: <?php echo $button_color;?>; border-color: <?php echo $button_color;?>;">
					<?php echo $button_one_text; ?>
				</a>
			<?php endif; ?>
			<?php if($button_two_href) : ?>
				<a href="<?php echo $button_two_href; ?>" target="_blank" class="btn btn-primary font-regular" style="background-color: <?php echo $button_color;?>; border-color: <?php echo $button_color;?>;">
...
function get_slider_items() {
	$items = array_filter(array(
		get_theme_mod('carousel_first_image'),
		get_theme_mod('carousel_second_image'),
		get_theme_mod('carousel_third_image'),
		get_theme_mod('carousel_fourth_image'),
		get_theme_mod('carousel_fifth_image'),
	));
	return $items;
}